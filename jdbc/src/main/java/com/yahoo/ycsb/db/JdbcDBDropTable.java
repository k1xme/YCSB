...
/**
 * Utility class to drop the table to be used by the benchmark.
 * 
 * @author k1xme
 */
public final class JdbcDBDropTable {

  private static void usageMessage() {
    System.out.println("Drop Table Client. Options:");
  ...
  private static void dropTable(Properties props, String tablename) throws SQLException {
  ...
  public static void main(String[] args) {
    ...
    try {
      dropTable(props, tablename);
    } catch (SQLException e) {
      System.err.println("Error in dropping table. " + e);
      System.exit(1);
    }
  }
